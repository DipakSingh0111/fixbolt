      ...
      <div className="site-container">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="bg-[#fff5f5] rounded-2xl p-6 border border-red-50">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-base font-bold text-gray-900">{quickBooking.title}</h3>
            ...
            <div className="bg-[#fffdfd] rounded-2xl p-8 border border-red-50/60 space-y-8 flex-1">
              <div>
                <h3 className="text-xl font-bold text-gray-900">{whyBook.title}</h3>
        ...
        <div className="mt-10 pt-6 border-t border-gray-100 grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          <div className="md:col-span-7 flex items-center space-x-3">
            ...
            <div>
              <h4 className="text-base font-bold text-gray-900">{footerHelp.title}</h4>
          ...
          <div className="md:col-span-5 flex items-center space-x-3">
            ...
            <div>
              <h4 className="text-base font-bold text-gray-900">{footerHelp.hoursTitle}</h4>
              <p className="text-base text-gray-500 mt-0.5 whitespace-pre-line">{footerHelp.hours}</p>
            </div>
          </div>
        </div>
        </div>
