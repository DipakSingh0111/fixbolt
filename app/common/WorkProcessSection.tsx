  ...
  return (
    <section className="work-process-section relative w-full bg-gradient-to-r from-[#800000] via-[#a30000] to-[#520000] text-white py-16 md:py-16 overflow-hidden">
      ...
      >
        ...
        <motion.h2
          variants={fadeInUp}
          className="text-[32px] sm:text-4xl md:text-5xl font-extrabold tracking-tight leading-[1.15]"
        >
        ...
        <motion.p
          variants={fadeInUp}
          className="max-w-[600px] mx-auto text-white/80 text-[14px] md:text-base font-light leading-relaxed"
        >
          {description}
        </motion.p>
      </motion.div>
      ...
      >
        ...
        <motion.div
          variants={fadeInUp}
          className="hidden lg:block absolute top-[70px] left-[15%] right-[15%] h-[2px] border-t-2 border-dashed border-white/40 z-0"
        />
