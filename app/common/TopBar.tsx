...
const itemClass =
  "flex shrink-0 items-center gap-[9px] text-[14px] transition-opacity hover:opacity-80";
const dividerClass = "h-[18px] w-px shrink-0 bg-white/40";
...
export default function TopBar({ data, className }: SectionProps<TopbarData> = {}) {
  ...
  return (
    <div className="w-full bg-brand-red text-white">
      <div className="site-container flex min-h-11 items-center gap-[22px]">
        {/* Phone */}
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2">
          {socialLinks.map((social: any) => (
            <a
              ...
              className="grid size-8 place-items-center rounded border border-white/40 transition-colors hover:border-white hover:bg-white/20"
            >
