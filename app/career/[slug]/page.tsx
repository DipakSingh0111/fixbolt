  ...
  return (
    <main className="bg-[#fbfbfb] min-h-screen font-sans pb-12">
      ...
      <div className="site-container mt-8 md:mt-12">
        ...
        <Link
          href="/career"
          className="inline-flex items-center gap-2 text-base font-bold text-[#cc1616] hover:text-[#a51212] transition-colors mb-8"
        >
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {detail.offers.map((offer) => {
                  ...
                  const OfferIcon =
                    offerIcons[offer.icon as keyof typeof offerIcons] ?? Users;
                  return (
                    <div
                      key={offer.title}
                      className="flex flex-col items-center text-center p-6 border border-gray-100 rounded-xl bg-white shadow-sm h-full hover:shadow-md transition-shadow"
                    >
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
              ...
              <form className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder={applyForm.placeholders.name}
                    className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-base focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="email"
                    placeholder={applyForm.placeholders.email}
                    className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-base focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="tel"
                    placeholder={applyForm.placeholders.phone}
                    className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-base focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
                  />
                </div>
                ...
                <div className="relative">
                  <select className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-base text-gray-500 appearance-none focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all">
                    <option value="">
                      {applyForm.placeholders.experience}
                    </option>
                ...
                <div className="pt-2">
                  ...
                  <div className="border-2 border-dashed border-red-200 bg-red-50/50 rounded-xl p-6 flex flex-col items-center justify-center text-center hover:bg-red-50 transition-colors cursor-pointer group">
                    ...
                    <span className="text-sm font-bold text-gray-900 mb-1">
                      {applyForm.resumeHint}
                    </span>
                    <span className="text-[10px] text-gray-500">
                      {applyForm.resumeMaxSize}
                    </span>
                  </div>
                </div>
                ...
                <button
                  type="button"
                  className="w-full bg-[#cc1616] hover:bg-[#a51212] text-white font-bold py-4 px-4 rounded-xl transition shadow-md flex items-center justify-center gap-2 text-base mt-4"
                >
            ...
            <div className="bg-[#fff5f5] rounded-2xl shadow-sm border border-red-50 p-8">
              ...
              <div className="space-y-5">
                <div className="flex gap-4 items-start">
                  ...
                  <div className="grid grid-cols-2 w-full gap-2 items-start">
                    <span className="text-base font-bold text-gray-900">
                      {detail.summaryLabels.jobTitle}
                    </span>
                    <span className="text-base font-semibold text-[#cc1616]">
                      {job.title}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="grid grid-cols-2 w-full gap-2 items-start">
                    <span className="text-base font-bold text-gray-900">
                      {detail.summaryLabels.experience}
                    </span>
                    <span className="text-base font-semibold text-[#cc1616]">
                      {job.experience}
                    </span>
